  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li<?php echo ($this->router->fetch_class() == 'widgets' ? ' class="active"' : ''); ?>>
    			<a href="<?php echo get_page_base_url('admin/widgets'); ?>"<?php echo ($this->router->fetch_class() == 'widgets' ? ' class="active"' : ''); ?>><i class="fa fa-cubes fa-fw"></i> <span>Widgets</span></a>
		    </li>	
